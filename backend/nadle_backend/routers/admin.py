...
async def get_inquiries(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail=f"Failed to get inquiries list: {str(e)}"
        )
...
async def get_all_posts(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail=f"Failed to get posts list: {str(e)}"
        )
...
async def update_post_status(
    ...
    """
    # Validate status
    valid_statuses = ["draft", "published", "archived", "deleted", "pending", "resolved", "rejected"]
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail=f"Failed to update post status: {str(e)}"
        )