...
class IndexManager:
    ...
    def get_post_indexes() -> List[IndexModel]:
        ...
        return [
            # Unique slug index
            IndexModel([("slug", ASCENDING)], unique=True, name="slug_unique_idx"),
    ...
    def get_comment_indexes() -> List[IndexModel]:
        ...
        return [
            ...
            IndexModel(
                [("parent_id", ASCENDING)], sparse=True, name="parent_comment_idx"
            ),
            # Text search for comment content
            IndexModel([("content", TEXT)], name="comment_text_search_idx"),
        ]
    ...
    def get_stats_indexes() -> List[IndexModel]:
        ...
        return [
            ...
            IndexModel([("last_updated", DESCENDING)], name="stats_updated_idx"),
        ]
    ...
    async def create_all_indexes(db: AsyncIOMotorDatabase) -> Dict[str, List[str]]:
        ...
        for collection_name, indexes in index_definitions.items():
            ...
            try:
                ...
                logger.info(
                    f"Created {len(created)} indexes for {collection_name} collection"
                )
